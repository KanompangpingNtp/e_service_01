...
<div class="container">
    ...
    <form action="{{ route('formsCreate') }}" method="POST" enctype="multipart/form-data">
        ...
        <p>วันที่ {{ date('j', strtotime(now())) }} {{ $months[date('n', strtotime(now()))] }} พ.ศ.{{ date('Y') + 543 }}</p>
        ...
        <div class="mb-3 col-md-4">
            <label for="complaintName" class="form-label">เรื่องที่ร้องเรียน<span class="text-danger">*</span></label>
